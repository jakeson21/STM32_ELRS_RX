...
C_SRCS += \
../elrs/config/feature.c 

OBJS += \
./elrs/config/feature.o 

C_DEPS += \
./elrs/config/feature.d 


# Each subdirectory must supply rules for building sources it contributes
elrs/config/%.o elrs/config/%.su: ../elrs/config/%.c elrs/config/subdir.mk
...
clean: clean-elrs-2f-config

clean-elrs-2f-config:
	-$(RM) ./elrs/config/feature.d ./elrs/config/feature.o ./elrs/config/feature.su

.PHONY: clean-elrs-2f-config
